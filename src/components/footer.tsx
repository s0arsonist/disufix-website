  ...
  return (
    <footer className="bg-black text-white">
      <div className="container-custom py-12">
        {/* Gradient Bar */}
        <div className="h-1 w-full bg-gradient-brand mb-8 rounded-full"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div style={{ transitionDelay: "0.1s" }}>
            ...
            <p className="text-sm text-gray-300 mb-4">
              Empresa que crea y ofrece productos quÃ­micos de alta tecnologÃ­a e
              innovaciÃ³n para mantenimiento y prevenciÃ³n en construcciones.
            </p>
            <div className="flex space-x-4">
              <Link
                href="https://www.facebook.com/Disuagrooficial"
                className="text-white hover:text-secondary transition-colors bg-black-light/30 p-2 rounded-full"
              >
                <Facebook size={18} />
              </Link>
              <Link
          ...
          <div style={{ transitionDelay: "0.2s" }}>
            ...
            <ul className="space-y-2">
              <li>
                ...
                >
                  <span className="mr-2 text-primary">âº</span>
                  Inicio
                </Link>
              </li>
              <li>
          ...
          <div style={{ transitionDelay: "0.4s" }}>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <div>
                  <p className="text-gray-300">Tel: 4002749</p>
                  <Link
                    href="https://www.facebook.com/Disuagrooficialhttps://api.whatsapp.com/send/?phone=573156458075&text&type=phone_number&app_absent=0"
              ...
              <li className="flex items-center">
                ...
                <a
                  href="mailto:servicioalcliente@disufix.com"
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-300">
                  Presencia en mÃºltiples ciudades de Colombia
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} Disufix. Todos los derechos
            reservados.
          </p>
          <p>By Negocios Creativos</p>
        </div>
      </div>
    </footer>
  );
